...
//            LOGGER.info("Array in document 1 is missing {} entries for {}.", (count2 - count1), path);
//        }
//        if (count1 > count2) {
//            differences.add(new DifferenceImplSimple(array1, array2, path, "Document 2 misses " + (count1 - count2) + " array entries"));
//            LOGGER.info("Array in document 2 is missing {} entries for {}.", (count1 - count2), path);
//        }
//
...
//        List<PdfName> missing1 = new ArrayList<>(dictionary2.keySet());
...
//        }
//
//        List<PdfName> missing2 = new ArrayList<>(dictionary1.keySet());
...
//        }
//
//        List<PdfName> common = new ArrayList<>(dictionary1.keySet());
...
//        compareContents(stream1, stream2, path);
//
...
//            SortedSet<List<String>> sortedSet = new TreeSet<>(pathComparator);
